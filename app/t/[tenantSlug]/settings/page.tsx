      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-white text-lg">{tenant.name}</p>
          </div>
          <div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left text-gray-400 pb-3 font-medium">
                  Name
                </th>
                <th className="text-left text-gray-400 pb-3 font-medium">
                  Email
            ...
            <tbody>
              {tenant.users.map((membership: { id: string; role: string; user: { name: string; email: string } }) => (
                ...
                >
                  <td className="py-3 text-white">{membership.user.name}</td>
                  <td className="py-3 text-gray-300">{membership.user.email}</td>
                  <td className="py-3">
                    <span
